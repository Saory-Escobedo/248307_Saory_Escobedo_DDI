...
const Usuarios = [
    ...
    },
    {
        nombre: "Saory",
        apellido: "Guzman",
        correo: "saory@gmail.com",
        constraseña: "12345678",
    },
    {
        nombre: "CarlosV",
        apellido: "elJoto",
        correo: "CarlosV@gmail.com",
        constraseña: "12345678",
    },
    {
        nombre: "Patito",
        apellido: "Juan",
        correo: "Patito@gmail.com",
        constraseña: "12345678",
    }
];
...
class Usuario{
    constructor(nom, ape,correo, constraseña){
        this.nombre = nom; 
        this.apellido = ape;
        this.correo = correo;
...
for(let i=0; i<Usuarios.length; i++)
{
    ...
    contenedor_usuario.onclick= () =>{
        ...
        const constraseña = document.createElement("input");
        constraseña.placeholder= "ingresa la contraseña";
        constraseña.type= "password";

        contenedor_usuario.appendChild(correo);
        contenedor_usuario.appendChild(constraseña);

        console.log(Usuarios[i].nombre);
        console.log(Usuarios[i].apellido);
        console.log(Usuarios[i].correo);
        console.log(Usuarios[i].constraseña);
    }
...
//crear un nuevo archivo , con un formulario de inicio de secion y registro con este metodo de leer el objeto por medio del from data
//valiadar que hayan ingresado todos los datos en los datos
// y de ahi que aparesca un cuadro con un cuadro de texto que diga sesion iniciada correctamente
//que pida correo y contraseña